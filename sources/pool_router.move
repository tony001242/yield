module yield::pool_router {
    ...
    use yield::liquidity_pool::{Self, LiquidityPool};
    ...
    #[view]
    public fun get_amount_out_from_coin<FromCoin>(
        amount_in: u64,
        to_token: Object<Metadata>,
    ): (u64, u64) {
        get_amount_out(amount_in, coin_wrapper::get_wrapper<FromCoin>(), to_token)
    }

    #[view]
    public fun get_amount_out_to_coin<ToCoin>(
        amount_in: u64,
        from_token: Object<Metadata>,
    ): (u64, u64) {
        get_amount_out(amount_in, from_token, coin_wrapper::get_wrapper<ToCoin>())
    }
