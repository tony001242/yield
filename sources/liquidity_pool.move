module yield::liquidity_pool {
    ...
    public entry fun initialize() {
        ...
        let swap_signer = &yield_package_manager::get_signer();
    ...
    public fun is_initialized(): bool {
        exists<LiquidityPoolConfigs>(@yield)
    }
    ...
    public fun liquidity_pool_address(
        ...
        object::create_object_address(&@yield, get_pool_seeds(token_1, token_2, is_stable))
    }
    ...
    inline fun create_lp_token(
        ...
        let lp_token_constructor_ref = &object::create_named_object(&yield_package_manager::get_signer(), seeds);
    ...
    inline fun safe_liquidity_pool_configs(): &LiquidityPoolConfigs acquires LiquidityPoolConfigs {
        borrow_global<LiquidityPoolConfigs>(@yield)
    }
    ...
    inline fun unchecked_mut_liquidity_pool_configs(): &mut LiquidityPoolConfigs acquires LiquidityPoolConfigs {
        borrow_global_mut<LiquidityPoolConfigs>(@yield)
    }
